...
// 0.10
//
// Your function will receive a weight w and a number of repetitions r and must return your projected one
// repetition maximum. Since you are not sure which formula to use and you are feeling confident, your
// function will return the largest value from the three formulas shown above, rounded to the nearest
// integer. However, if the number of repetitions passed in is 1 (i.e., it is already a one rep max),
